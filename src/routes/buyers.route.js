...
router.post("/:id/locations",requiresPermission("buyers","update"),c.addLocation); router.put("/:id/locations/:locationId",requiresPermission("buyers","update"),c.updateLocation);
